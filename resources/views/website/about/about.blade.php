        ...
        <div class="about-us__content pb-5 mb-5">
            ...
            <div class="mw-930 d-lg-flex align-items-lg-center">
                ...
                <div class="content-wrapper col-lg-6 px-lg-4">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet sapien dignissim a elementum. Sociis
                        metus, hendrerit mauris id in. Quis sit sit ultrices tincidunt euismod luctus diam. Turpis sodales
            ...
            <div class="swiper-container js-swiper-slider"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img loading="lazy" src="{{ asset('images/brands/brand1.png') }}" width="120" height="20"
                            alt="">
                    </div>
                    <div class="swiper-slide">
                        <img loading="lazy" src="{{ asset('images/brands/brand2.png') }}" width="87" height="20"
                            alt="">
                    </div>
                    <div class="swiper-slide">
                        <img loading="lazy" src="{{ asset('images/brands/brand3.png') }}" width="132" height="22"
                            alt="">
                    </div>
                    <div class="swiper-slide">
                        <img loading="lazy" src="{{ asset('images/brands/brand4.png') }}" width="72" height="21"
                            alt="">
                    </div>
                    <div class="swiper-slide">
                        <img loading="lazy" src="{{ asset('images/brands/brand5.png') }}" width="123" height="31"
                            alt="">
                    </div>
                    <div class="swiper-slide">
                        <img loading="lazy" src="{{ asset('images/brands/brand6.png') }}" width="137" height="22"
                            alt="">
                    </div>
                    <div class="swiper-slide">
                        <img loading="lazy" src="{{ asset('images/brands/brand7.png') }}" width="94" height="21"
                            alt="">
                    </div>
                </div><!-- /.swiper-wrapper -->
